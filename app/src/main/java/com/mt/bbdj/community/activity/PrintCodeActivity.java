...
public class PrintCodeActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void actionTo(Context context,String user_id,String mail_id,String goods_name,String weight,String money) {
        Intent intent = new Intent(context, PrintCodeActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtils.StatusBarLightMode(PrintCodeActivity.this);
        initParams();
        initView();
    ...
    private void getPannelData() {
        ...
        mRequestQueue.add(REQUEST_GET_DATA, request, new OnResponseListener<String>() {
            ...
            public void onStart(int what) {
                LoadDialogUtils.getInstance().showLoadingDialog(PrintCodeActivity.this);
            }
...
//                }
    ...
    private void requestBluetoothPermission() {
        if (Build.VERSION.SDK_INT >= 23) {
            //校验是否已具有模糊定位权限
            if (ContextCompat.checkSelfPermission(PrintCodeActivity.this,
                    android.Manifest.permission.ACCESS_COARSE_LOCATION)
                    != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(PrintCodeActivity.this,
