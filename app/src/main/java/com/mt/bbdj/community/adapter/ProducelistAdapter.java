 ...
 * Description :
 */
public class ProducelistAdapter extends RecyclerView.Adapter<ProducelistAdapter.SimpleViewHolder> {

    private List<HashMap<String, String>> mList;

    private Context context;

    public ProducelistAdapter(Context context, List<HashMap<String, String>> list) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_simple_product_string,parent,false);
    ...
    public void onBindViewHolder(SimpleViewHolder holder, final int position) {
        ...
        Glide.with(context).load(data.get("product_image")).into(holder.goodsImage);
    ...
    class SimpleViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView goodsImage;   //商品
        ...
        public SimpleViewHolder(View itemView) {
            ...
            goodsImage = itemView.findViewById(R.id.item_goods_image);
        }
    }
