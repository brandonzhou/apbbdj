 ...
 * Description :
 */
public class GlobalSearchOutFinishFragment extends BaseFragment implements XRecyclerView.LoadingListener {
    ...
    public static GlobalSearchOutFinishFragment getInstance() {
        GlobalSearchOutFinishFragment gf = new GlobalSearchOutFinishFragment();
        return gf;
    }
