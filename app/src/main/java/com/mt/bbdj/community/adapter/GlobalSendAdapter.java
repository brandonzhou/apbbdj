 ...
 * Description :   待收件适配器
 */
public class GlobalSendAdapter extends RecyclerView.Adapter<GlobalSendAdapter.WaitCollectViewHolder> {
    ...
    public GlobalSendAdapter(Context context, List<HashMap<String, String>> list) {
        this.mList = list;
    ...
    public void onBindViewHolder(WaitCollectViewHolder holder, final int position) {
        ...
        if ("1".equals(states)) {
            holder.tvState.setText("待收件");
            holder.relativeLayout.setVisibility(View.VISIBLE);
            holder.btCannel.setVisibility(View.VISIBLE);
            holder.btFistSave.setVisibility(View.VISIBLE);
        } else if ("2".equals(states)) {
            holder.tvState.setText("已处理");
            holder.relativeLayout.setVisibility(View.GONE);
        } else if ("3".equals(states)) {
            holder.tvState.setText("待打印");
            holder.relativeLayout.setVisibility(View.VISIBLE);
            holder.btCannel.setVisibility(View.GONE);
            holder.btFistSave.setVisibility(View.GONE);
        }
    ...
    class WaitCollectViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tvState;   //立刻打印
        private RelativeLayout relativeLayout;   //功能按钮布局
        ...
        public WaitCollectViewHolder(View itemView) {
            ...
            relativeLayout = itemView.findViewById(R.id.rl_function);
        }
    }
