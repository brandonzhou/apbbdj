...
public class PrintTakeNumberActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void actionTo(Context context,PrintTagModel printTagModel) {
        Intent intent = new Intent(context, PrintTakeNumberActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtils.StatusBarLightMode(PrintTakeNumberActivity.this);
        initView();
        initPannelData();
...
//        });
    ...
    private void printPanel(String code,String code_head,String qrcode,String pie_number) {
        try {
            ...
            HPRTPrinterHelper.PrintQR(HPRTPrinterHelper.BARCODE, "375", "45", "2", "6", qrcode);
    ...
    private void requestBluetoothPermission() {
        if (Build.VERSION.SDK_INT >= 23) {
            //校验是否已具有模糊定位权限
            if (ContextCompat.checkSelfPermission(PrintTakeNumberActivity.this,
                    android.Manifest.permission.ACCESS_COARSE_LOCATION)
                    != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(PrintTakeNumberActivity.this,
