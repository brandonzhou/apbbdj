...
public class CameraConfigurationManager {
    ...
    private static final String TAG = com.rxfeature.module.scaner.CameraConfigurationManager.class.getSimpleName();
    ...
    private void setFlash(Camera.Parameters parameters) {
        if (Build.MODEL.contains("Behold II") && CameraHelper.SDK_INT == 3) { // 3 = Cupcake
