 ...
 * Description :
 */
public class BarChartManager {private BarChart mBarChart;
...
//        mBarChart.setHighlightFullBarEnabled(false);
        ...
        mBarChart.setVisibleXRangeMaximum(12);//需要在设置数据源后生效
        mBarChart.setVisibleXRangeMinimum(1);//设置最少数量，不常用。
...
//        设置Y轴的最小值和最大值
    ...
    public void showMoreBarChart(final List<Float> xAxisValues, List<List<Float>> yAxisValues, List<String> labels, List<Integer> colours) {
        ...
        final String[] xValues = {"2019.2.27", "2019.2.28", "2019.3.1", "2019.3.2", "2019.3.3","2019.3.4","2019.3.5"};
