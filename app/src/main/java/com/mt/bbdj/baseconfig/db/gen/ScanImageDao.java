...
public class ScanImageDao extends AbstractDao<ScanImage, String> {
    ...
    public static class Properties {
        ...
        public final static Property BatchNo = new Property(5, int.class, "batchNo", false, "BATCH_NO");
        public final static Property StationId = new Property(6, String.class, "stationId", false, "STATION_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SCAN_IMAGE\" (" + //
                ...
                "\"BATCH_NO\" INTEGER NOT NULL ," + // 5: batchNo
                "\"STATION_ID\" TEXT," + // 6: stationId
    ...
    protected final void bindValues(DatabaseStatement stmt, ScanImage entity) {
        ...
        stmt.bindLong(6, entity.getBatchNo());
 
        String stationId = entity.getStationId();
        if (stationId != null) {
            stmt.bindString(7, stationId);
        }
    ...
    public ScanImage readEntity(Cursor cursor, int offset) {
        ScanImage entity = new ScanImage( //
            ...
            cursor.getInt(offset + 5), // batchNo
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // stationId
    ...
    public void readEntity(Cursor cursor, ScanImage entity, int offset) {
        ...
        entity.setBatchNo(cursor.getInt(offset + 5));
        entity.setStationId(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
