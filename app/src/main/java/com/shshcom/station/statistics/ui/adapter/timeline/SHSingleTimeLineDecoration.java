...
public abstract class SHSingleTimeLineDecoration extends TimeLine {
    public SHSingleTimeLineDecoration(Config config) {
        super(config);
    }
