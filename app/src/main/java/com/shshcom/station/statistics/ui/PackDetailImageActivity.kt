...
class PackDetailImageActivity : AppCompatActivity() , OnTabSelectListener{
    ...
    private fun initData() {
        ...
        val inImage = intent.getBooleanExtra("inImage", true)
    ...
    fun showTime(time :String, textView: TextView){
    ...
    override fun onTabSelect(position: Int) {
        if(position == 0){
            ...
            showTime(data.warehousingTime, tv_pack_detail_time_1)
            ...
            if(data.outPicture.isNullOrEmpty() && data.outPictureFace.isNullOrEmpty()){
                ...
                showTime(data.outTime, tv_pack_detail_time_1)
                showTime(data.outTime, tv_pack_detail_time_2)
                cl_none_image.visibility = View.GONE
            }
