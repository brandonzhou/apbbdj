 ...
 import com.shshcom.camera.config.SHResolutionCameraConfig;

 import java.io.File;
 import java.nio.ByteBuffer;
 import java.util.concurrent.Executors;

 public class SHBaseCameraScan<T> extends CameraScan<T> {
     ...
     private SHResolutionCameraConfig mCameraConfig;
     ...
     public SHBaseCameraScan(@NonNull FragmentActivity activity, @NonNull  PreviewView previewView){
     ...
     public SHBaseCameraScan(@NonNull Fragment fragment, @NonNull PreviewView previewView){
...
//                     }
     ...
     private void initConfig(){
         if(mCameraConfig == null){
             mCameraConfig = new SHResolutionCameraConfig(mContext);
         }
     }
