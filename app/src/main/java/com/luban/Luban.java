...
public class Luban implements Handler.Callback {
 ...
 /*   String cacheBuilder = mTargetDir + "/" +imageName+
            (TextUtils.isEmpty(suffix) ? ".jpg" : suffix);
*/
  ...
  /**
   * start asynchronous loading_compress_photo thread
   */
  @UiThread
  ...
  /**
   * start loading_compress_photo and return the mFile
   */
  @WorkerThread
  ...
  public static class Builder {
    ...
    public Builder setTargetDir(String targetDir, String imageName) {
    ...
    /**
     * do not loading_compress_photo when the origin image file size less than one value
     *
     * @param size
    ...
    /**
     * begin loading_compress_photo image with asynchronous
     */
    public void launch() {
    ...
    /**
     * begin loading_compress_photo image with synchronize
     *
